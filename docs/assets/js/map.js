...
const RT_PATH = map_path.concat('/', "Rt.csv");
const CASE_PROJECTION_PATH = map_path.concat('/', "Cproj.csv");
const CASE_PREDICTION_PATH = map_path.concat('/', "Cpred.csv");

const SITE_DATA_PATH = assets.concat('/', "site_data.csv");
const NHS_SCOTLAND_MAP = assets.concat('/', "nhs_scotland_health_boards.csv");
const ENGLAND_META_AREA_MAP = assets.concat('/', "england_meta_areas.csv");
const METADATA_PATH = assets.concat('/', "metadata.csv");
const TOPOJSON_PATH = assets.concat('/', "uk_lad_boundaries.json");
