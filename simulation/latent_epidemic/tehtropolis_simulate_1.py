...
mixing_proportions = np.ones_like(R[0, :]) * 0.45  # 0.05 * R[0, :].squeeze() / 2.5
...
save_simulation_with_data(
    X, C, R, params, "tehtropolis/sample_rss_paper_1", base_data_dir="tehtropolis/data"
)
plt.savefig("tehtropolis/sample_rss_paper_1/cases_r.pdf")
